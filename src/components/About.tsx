...
const About = () => {
  return (
    <section id="about" className="py-section bg-gradient-to-b from-background to-accent/30">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                Меня зовут <span className="font-semibold text-foreground">Дмитрий, мне 17</span>. 
                Я — дизайнер инфографики, специализируюсь на продающих карточках для маркетплейсов.
              </p>

              <p className="text-lg leading-relaxed text-muted-foreground">
                Упаковка — первое, что видит покупатель. Моя задача — сделать так, 
                чтобы он не ушёл без заказа.
              </p>

              <div className="pt-4">
                <p className="text-xl font-semibold text-primary mb-6">
                  «Превращаю обычные карточки в инструменты продаж»
                </p>
              </div>
            ...
            <div className="relative animate-scale-in">
              <div className="relative">
                ...
                <div className="card-elegant p-8 text-center">
                  ...
                  <h3 className="text-2xl font-heading font-bold mb-2">Дмитрий Уланов</h3>
                  <p className="text-primary font-medium mb-4">Дизайнер инфографики</p>
                  <p className="text-sm text-muted-foreground">
                    Специализируюсь на продающих карточках для маркетплейсов
                  </p>
                </div>
