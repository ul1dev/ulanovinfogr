...
const Hero = () => {
    ...
    return (
        <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-site px-4 py-section relative z-10">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed animate-slide-up max-w-3xl mx-auto">
                        Создаю визуальные карточки, которые выделяют товар в
                        выдаче и убеждают купить за 3 секунды
                    </p>
            ...
            <div className="absolute bottom-8 left-0 sm:left-2 right-0 flex justify-center animate-bounce">
