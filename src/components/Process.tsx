import { FileText, Search, Lightbulb, PaintBucket, BarChart3, Download } from 'lucide-react';
...
const Process = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Создаю варианты дизайна и согласовываю с вами концепцию",
      duration: "1 день"
    },
    {
      icon: PaintBucket,
      title: "Подготовка слайдов",
      description: "Дорабатываю детали, делаю ретушь и финальные корректуры",
      duration: "1-2 дня"
    },
    {
      icon: BarChart3,
      title: "Тест CTR / Примерка",
      description: "При необходимости тестируем варианты или делаем примерку",
      duration: "по запросу"
    },
    {
      icon: Download,
      title: "Передача файлов",
      description: "Отправляю готовые файлы и исходники в нужных форматах",
      duration: "сразу"
    }
  ];

  return (
    <section id="process" className="py-section bg-gradient-to-b from-background to-accent/20">
      <div className="container mx-auto max-w-site px-4">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 animate-fade-in">
          <div className="text-center p-6 rounded-2xl bg-primary/5 border border-primary/20">
            ...
            <div className="text-sm text-muted-foreground">дня на базовый пакет</div>
          </div>
          
          <div className="text-center p-6 rounded-2xl bg-primary/5 border border-primary/20">
            <div className="text-3xl font-bold text-primary mb-2">100%</div>
            <div className="text-sm text-muted-foreground">прозрачность процесса</div>
          </div>
          
          <div className="text-center p-6 rounded-2xl bg-primary/5 border border-primary/20">
            <div className="text-3xl font-bold text-primary mb-2">24/7</div>
            <div className="text-sm text-muted-foreground">поддержка в Telegram</div>
          </div>
        </div>
      </div>
    </section>
